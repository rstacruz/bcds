...
intermission: |-
  ...
  <div class='container'>
    <form action="https://docs.google.com/forms/d/1eWR3AyJ-7Mb8nK5vjkyr_bitMK27pBbZnVzrdqSz1zE/formResponse?embedded=true" method="POST" id="ss-form" target="_self"<ol role="list" class="ss-question-list" style="padding-left: 0">
      ...
      <input placeholder='Last name, First name' name="entry.404801151" value="" class="ss-q-short" id="entry_404801151" dir="auto" aria-label="Name LAST NAME, FIRST NAME " aria-required="true" required="" title="" type="text">
